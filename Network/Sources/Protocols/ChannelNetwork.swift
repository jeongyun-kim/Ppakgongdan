...
protocol ChannelNetwork {
    ...
    func createNewChannel(workspaceId: String, name: String, desc: String?) async throws -> ChannelDTO
    func getAllChannels(workspaceId: String) async throws -> [ChannelDTO]
    func getAllMyChannels(workspaceId: String) async throws -> [ChannelDTO]
